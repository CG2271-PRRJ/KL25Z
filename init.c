...
void initLED(void)
{
	...
	PORTA->PCR[GREEN_LED_01] &= ~PORT_PCR_MUX_MASK;
	PORTA->PCR[GREEN_LED_01] |= PORT_PCR_MUX(1);
	PORTA->PCR[GREEN_LED_02] &= ~PORT_PCR_MUX_MASK;
	PORTA->PCR[GREEN_LED_02] |= PORT_PCR_MUX(1);
	PORTD->PCR[GREEN_LED_03] &= ~PORT_PCR_MUX_MASK;
	PORTD->PCR[GREEN_LED_03] |= PORT_PCR_MUX(1);
	PORTA->PCR[GREEN_LED_04] &= ~PORT_PCR_MUX_MASK;
	PORTA->PCR[GREEN_LED_04] |= PORT_PCR_MUX(1);
	PORTA->PCR[GREEN_LED_05] &= ~PORT_PCR_MUX_MASK;
	PORTA->PCR[GREEN_LED_05] |= PORT_PCR_MUX(1);
